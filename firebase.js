...
import {
  getFirestore, doc, setDoc, getDoc, updateDoc, deleteDoc, collection, getDocs, query, orderBy, limit,
...
export {
  db, doc, setDoc, getDoc, updateDoc, deleteDoc, collection, getDocs, query, orderBy, limit,
  onSnapshot, runTransaction,
};
